  ...
  methods: {
    ...
    openConfirm(){
      this.$vs.dialog({
        ...
        color: 'danger',
        title: `Confirm`,
        text: "Pressing the help button sends a toll-free text message to everyone on your contacts list. " + " They will see your customized message and will be able text you back at your phone number: " + this.phoneNumber.phone_number,
